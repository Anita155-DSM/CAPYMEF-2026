...
export const crearNuevoEvento = async (formData) => {
    try {
        ...
        // Ajustá esta ruta según cómo la tengas definida en tu admin.routes.js
...
export const obtenerTodosLosEventos = async () => {
    try {
        const token = localStorage.getItem("token");
        // Usamos /eventos/socios porque el backend de Ana trae todos 
        // los eventos sin excluir los cancelados para los usuarios autenticados.
